...
<template>
  <div class="mt-6 flex-1 min-h-0">
    ...
    <div v-else-if="!insumos.length" class="flex h-full min-h-[200px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-transparent py-8 text-center px-4">
    ...
    >
      <li v-for="insumo in insumos" :key="insumo._id" class="group flex items-center justify-between rounded-2xl border border-slate-100 bg-transparent p-3 transition-colors hover:bg-transparent">
        <div class="flex items-center gap-3">
