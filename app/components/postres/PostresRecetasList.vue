...
<template>
  <div class="mt-6 flex-1 min-h-0">
    <div
      v-if="!activePostre"
      class="flex h-full min-h-[150px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-transparent py-8 text-center px-4"
    >
      <UIcon
